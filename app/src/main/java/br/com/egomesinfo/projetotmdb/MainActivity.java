...
import br.com.egomesinfo.projetotmdb.adapter.MoviesAdapter;
...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void checkSortOrder(){
        ...
        String sortOrder = preferences.getString(
                this.getString(R.string.preft_sort_order_key),
                this.getString(R.string.preft_most_popular)

        );
        if (sortOrder.equals(this.getString(R.string.preft_most_popular))) {
